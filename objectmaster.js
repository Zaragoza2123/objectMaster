const pokemon = Object.freeze([
    ...
    const idBy3 = pokemon.filter( p => p.id % 3 == 0);
    console.log(idBy3);
    console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
    ...
    const twoTypes = pokemon.filter(p => p.types.includes(p.types[1]));
    ...
    const names99 = pokemon.filter( p => p.id > 99).map(p => p.name);
    console.log(names99);
    console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
    ...
    const flyer2nd = pokemon.filter( p => p.types[1] == 'flying').map(p => p.types[0]);
    console.log(flyer2nd);
    console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')

    console.log('a count of the number of pokémon that are "normal" type');
    const num = pokemon.filter(p => p.types.includes('normal'));
